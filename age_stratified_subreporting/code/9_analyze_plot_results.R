...
########################################################
subreportDeath <- read.csv("../datos_procesados/4_subreportingEstimate_death_20201228_cutLast_7.csv") %>%
  dplyr::mutate(., date=lubridate::as_date(date))
subreportCrit <- read.csv("../datos_procesados/4_subreportingEstimate_critical_20201228_cutLast_7.csv") %>%
  dplyr::mutate(., date=lubridate::as_date(date))
subreportSevere <- read.csv("../datos_procesados/4_subreportingEstimate_hosp_20201228_cutLast_7.csv") %>%
  dplyr::mutate(., date=lubridate::as_date(date))
